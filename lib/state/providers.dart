...
import '../data/translation_client.dart';
...
final Provider<TranslationClient> translationClientProvider =
    Provider<TranslationClient>(
      (Ref ref) => TranslationClient(ref.watch(netClientProvider)),
    );
